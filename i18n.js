...
(function () {
  ...
  var COMMON = {
    en: { site_name_prefix:"Modu", site_name_suffix:"Tools", footer_note:"ⓒ ModuTools · Everything runs in your browser. We never store what you enter.",
      ...
      c_char_t:"Characters", c_salary_t:"Take-home Pay", c_pct_t:"Percent", c_img_t:"Image Compress", c_react_t:"Reaction", c_age_t:"Age", c_dday_t:"D-day", c_bmi_t:"BMI", c_lotto_t:"Lotto", c_yt_t:"YT Thumbnail", c_pc_t:"Phone Contract", c_cs_t:"Child Safety Map" },
    ja: { site_name_prefix:"モドゥ", site_name_suffix:"ツール", footer_note:"ⓒ モドゥツール · すべての処理はブラウザ内で完結し、入力内容は保存されません。",
      ...
      c_char_t:"文字数", c_salary_t:"手取り計算", c_pct_t:"パーセント", c_img_t:"画像圧縮", c_react_t:"反応速度", c_age_t:"満年齢", c_dday_t:"Dデー", c_bmi_t:"BMI", c_lotto_t:"ロト", c_yt_t:"サムネイル", c_pc_t:"スマホ契約書", c_cs_t:"子ども安全マップ" },
    zh: { site_name_prefix:"全民", site_name_suffix:"工具", footer_note:"ⓒ 全民工具 · 所有计算均在浏览器内完成，不会保存您输入的内容。",
      ...
      c_char_t:"字数统计", c_salary_t:"到手工资", c_pct_t:"百分比", c_img_t:"图片压缩", c_react_t:"反应速度", c_age_t:"周岁", c_dday_t:"倒数日", c_bmi_t:"BMI", c_lotto_t:"乐透", c_yt_t:"缩略图", c_pc_t:"手机契约", c_cs_t:"儿童安全地图" }
  };
  var saved = {};
  function dict(lang) {
